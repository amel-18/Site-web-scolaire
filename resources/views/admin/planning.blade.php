	...
	<div class="container mb-6">
		 <div class="row mt-5">
            ...
            <div class="col-12 mt-3">
                <form class="needs-validation" method="post" action="{{ route('admin.planning.edit.post') }}">
                    @csrf
                    ...
                    <a href="{{ route('admin.planning.delete', $planning->id) }}" class="btn btn-danger">Supprimer</a>
                </form>
            </div>
        </div>
	</div>
